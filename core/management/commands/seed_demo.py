        ...
        for i in range(count):
            ...
            DailyParameter.objects.update_or_create(
                ...
                defaults={
                    ...
                    'water_level_morning_cm': Decimal('75.00') + Decimal(i % 36),
                    'water_level_evening_cm': Decimal('78.00') + Decimal(i % 34),
                    ...
                    'transparency_morning': Decimal('35.00') + Decimal(i % 5),
                    'transparency_evening': Decimal('32.00') + Decimal(i % 5),
                    'feed_kg': Decimal('30.00') + Decimal(i % 20),
                    'mortality': i % 18,
                    'water_color': random.choice(['Hijau kecoklatan', 'Coklat muda', 'Hijau plankton', 'Cerah kehijauan']),
                    'water_color_morning': random.choice(['CH', 'HC', 'C', 'Hijau kecoklatan']),
                    'water_color_evening': random.choice(['CH', 'HC', 'C', 'Coklat muda']),
