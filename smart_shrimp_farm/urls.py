...
urlpatterns = [
 ...
 path('finance/', include('finance.urls')), path('payroll/', include('payroll.urls')), path('investor/', include('investor.urls')), path('weather/', include('weather_ai.urls')), path('chat-ai/', include('chat_ai.urls')),
