...
urlpatterns = [
    ...
    path('tax/trade/document/<int:pk>/preview/', views.preview_trade_document, name='preview_trade_document'),
    path('tax/trade/document/<int:pk>/download/', views.download_trade_document, name='download_trade_document'),
