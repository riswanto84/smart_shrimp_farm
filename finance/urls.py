...
urlpatterns = [
    ...
    path('expenses/<int:pk>/documents/upload/', views.upload_expense_documents, name='upload_expense_documents'), path('expenses/document/<int:pk>/delete/', views.delete_expense_document, name='delete_expense_document'),
