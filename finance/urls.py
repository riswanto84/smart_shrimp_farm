...
urlpatterns = [
    ...
    path('expenses/<int:pk>/documents/upload/', views.upload_expense_documents, name='upload_expense_documents'),
    path('expenses/document/<int:pk>/preview/', views.preview_expense_document, name='preview_expense_document'),
    path('expenses/<int:pk>/receipt/preview/', views.preview_expense_receipt, name='preview_expense_receipt'),
    path('expenses/document/<int:pk>/delete/', views.delete_expense_document, name='delete_expense_document'),
    ...
    path('tax/balance/entries/',views.balance_entries,name='balance_entries'), path('tax/balance/entries/add/',views.add_balance_entry,name='add_balance_entry'), path('tax/balance/',views.balance_sheet,name='balance_sheet'), path('tax/trial-balance/',views.trial_balance,name='trial_balance'), path('tax/general-ledger/',views.general_ledger,name='general_ledger'), path('tax/balance/pdf/',views.export_balance_sheet_pdf,name='export_balance_sheet_pdf'),
    ...
    path('tax/trade/<int:pk>/documents/upload/', views.upload_trade_documents, name='upload_trade_documents'),
    path('tax/trade/document/<int:pk>/delete/', views.delete_trade_document, name='delete_trade_document'),
