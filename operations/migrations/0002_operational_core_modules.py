    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateField(default=django.utils.timezone.localdate)),
                ('doc', models.PositiveIntegerField(default=0)),
                ('anco1_morning', models.CharField(choices=[('H', 'Habis'), ('S', 'Sisa'), ('SS', 'Sisa Sedikit'), ('-', 'Tidak Dicek')], default='-', max_length=2)),
                ('anco2_morning', models.CharField(choices=[('H', 'Habis'), ('S', 'Sisa'), ('SS', 'Sisa Sedikit'), ('-', 'Tidak Dicek')], default='-', max_length=2)),
                ('anco1_noon', models.CharField(choices=[('H', 'Habis'), ('S', 'Sisa'), ('SS', 'Sisa Sedikit'), ('-', 'Tidak Dicek')], default='-', max_length=2)),
                ('anco2_noon', models.CharField(choices=[('H', 'Habis'), ('S', 'Sisa'), ('SS', 'Sisa Sedikit'), ('-', 'Tidak Dicek')], default='-', max_length=2)),
                ('anco1_evening', models.CharField(choices=[('H', 'Habis'), ('S', 'Sisa'), ('SS', 'Sisa Sedikit'), ('-', 'Tidak Dicek')], default='-', max_length=2)),
                ('anco2_evening', models.CharField(choices=[('H', 'Habis'), ('S', 'Sisa'), ('SS', 'Sisa Sedikit'), ('-', 'Tidak Dicek')], default='-', max_length=2)),
